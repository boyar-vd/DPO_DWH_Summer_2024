...
from python_scripts.config import connection_yandex_cloud_dwh


def csv_load(engine):
    """Create Pandas DataFrame with data from csv and insert data to database"""
...
with DAG('load_data_from_csv',  # dag_name
         description='dag_for_load_csv_to_db',
